...
const MainComponent = (props) => {
    const { socket, setSocket, name, setName, id, setUserId,setAuth, joiningRoom } = props
    ...
    useEffect(async () => {
        ...
        axios({
            ...
            roomsRef.current = data.data.rooms
        })
    }, [])
    ...
    const createRoom = () => {
        axios({
            ...
            console.log(data)
            const roomsUpdate = [...rooms, data.data]
            roomsRef.current = roomsUpdate
